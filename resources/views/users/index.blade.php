          ...
          <div class="card-body">
            <div class="d-flex align-items-center gap-2 mb-2">
              <div class="rounded-circle d-flex align-items-center justify-content-center text-white fw-bold"
                   style="width:44px;height:44px;background:{{ $u->role === 'admin' ? '#ef4444' : ($u->role === 'employee' ? '#3b82f6' : '#22c55e') }};">
            ...
            <div class="d-flex justify-content-end gap-2 mt-3">
              ...
              <form method="POST" action="{{ route('users.destroy', $u->user_id) }}" onsubmit="return confirm('Delete this user?');">
                @csrf
                @method('DELETE')
